const API_URL = "https://sutentable-api-project-oficial.onrender.com/api/actions";
        ...
        try {
            ...
            data.forEach(action => {
                ...
                actionItem.innerHTML = `
                    ...
                    <button syle{background-colo: red;} onclick="deleteAction('${action._id}')">Deletar</button>
                `;
